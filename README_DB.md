...
Este script contém a estrutura completa para armazenar todos os dados do sistema, permitindo dados duplicados em clientes.
...
CREATE TABLE users (
  ...
  nome TEXT,
  email TEXT UNIQUE, -- Mantido UNIQUE apenas para login de usuários do sistema
  papel TEXT CHECK (papel IN ('Administrador', 'Operador', 'Analista')),
  password TEXT, 
  created_at TIMESTAMP WITH TIME ZONE DEFAULT TIMEZONE('utc', NOW())
);

-- 3. Tabela de Clientes (TOTALMENTE SEM RESTRIÇÕES UNIQUE)
CREATE TABLE clients (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  nome TEXT,
  cpf_cnpj TEXT, -- Permitido repetir CPF/CNPJ
  email TEXT,    -- Permitido repetir Email
  telefone TEXT,
  endereco TEXT,
